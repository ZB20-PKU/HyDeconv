...
*   **`Hybrid Deconvolution Software Handbook.pdf`**: Complete user manual with detailed installation, operation, and configuration instructions.
...
For full instructions on software installation, operation, and configuration, please refer to the user manual:
