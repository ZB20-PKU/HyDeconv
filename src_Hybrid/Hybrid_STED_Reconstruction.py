...
class ParameterWidget(QWidget):
    ...
    def __init__(self, param_name, param_type, default_value, tooltip="", unit="", parent=None):
        ...
        label_text = label_text.replace('Sted', 'STED')
...
class STEDReconstructionGUI(QMainWindow):
    ...
    def init_ui(self):
        self.setWindowTitle("Hybrid-STED Reconstruction")
        # 修改：设置窗口大小为1200x900
        ...
        # 标题
        title_label = QLabel("Hybrid-STED Reconstruction Parameters")
        ...
        hessian_params = {
            'Raw_data_path': {
                'type': 'file',
                'default': './Demo_Recon_STED.tif',
                'tooltip': 'Path to STED raw data TIFF file'
            },
            'Hessian_fidelity': {
                'type': 'float',
                'default': 150,
        ...
        tdv_params = {
            'TDV_model_path': {
                'type': 'file',
                'default': './src_Hybrid/src_model/TDV_STED_Mito.pth',
        ...
        self.hessian_display = ImageDisplayContainer("Hessian-STED Reconstruction")
        self.hessian_tdv_display = ImageDisplayContainer("Hessian+TDV-STED Reconstruction")
        self.hybrid_background_display = ImageDisplayContainer("Hybrid-STED Background")
        self.hybrid_display = ImageDisplayContainer("Hybrid-STED Reconstruction")
    ...
    def export_current_parameters(self):
        ...
        try:
            ...
            try:
                ...
                # 如果 fname 不存在，使用空字符串作为基础名称
                base_name = "Demo_Recon_STED_Recon_Parameters.json"
    ...
    def export_images(self):
        ...
        # 创建复选框 - 修改为STED相关选项
        self.export_hessian_checkbox = QCheckBox("Hessian-STED Reconstruction")
        self.export_hessian_tdv_checkbox = QCheckBox("Hessian+TDV-STED Reconstruction")
        self.export_hybrid_background_checkbox = QCheckBox("Hybrid-STED Background")
        self.export_hybrid_checkbox = QCheckBox("Hybrid-STED Reconstruction")
