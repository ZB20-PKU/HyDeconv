...
# 导入训练相关模块
from src.default_config import default_config_TDV_WFM_training
from src.FM_Dataset import WFM_Dataset
    ...
    def run(self):
        try:
            ...
            if self.operation_type in ["dataset", "both"]:
                ...
                self.fm_dataset = WFM_Dataset(self.args, update_dataset_progress)
...
class ParameterWidget(QWidget):
    ...
    def __init__(self, param_name, param_type, default_value, tooltip="", unit="", parent=None):
        ...
        if param_name == 'FM_raw_data_folder_path':
            label_text = "WFM Raw Data Folder Path"
        elif param_name == 'WFM_BF_PSF_path':
            label_text = "WFM BF PSF Path"
...
class TDVTrainingGUI(QMainWindow):
    ...
    def __init__(self):
        super().__init__()
        self.args = default_config_TDV_WFM_training()
